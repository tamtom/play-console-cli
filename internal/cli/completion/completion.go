...
const completionSetupInstructions = `
Generate shell completions:
  gplay completion bash   # Bash completions
  gplay completion zsh    # Zsh completions
  gplay completion fish   # Fish completions

Setup:
  # Bash
  source <(gplay completion bash)

  # Zsh
  gplay completion zsh > "${fpath[1]}/_gplay"

  # Fish
  gplay completion fish | source
