...
var catalog = []Capability{
	...
	{
		ID:          "app.one_time_products",
		Intent:      "Create, read, update, and delete one-time products",
		Command:     "gplay onetime-products",
		Status:      StatusOfficial,
		Provider:    "android-publisher-api",
		APIResource: "monetization.onetimeproducts.*",
		Stability:   "stable",
		Notes:       "Uses the current monetization API; gplay iap remains a legacy compatibility surface.",
	},
	{
		ID:          "app.subscription_base_plan_states",
		Intent:      "Delete base plans and batch update base plan states",
		Command:     "gplay baseplans",
		Status:      StatusOfficial,
		Provider:    "android-publisher-api",
		APIResource: "monetization.subscriptions.basePlans.delete, monetization.subscriptions.basePlans.batchUpdateStates",
		Stability:   "stable",
	},
	{
